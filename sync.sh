...
FILE_KEYS=( ".zshrc" ".zshrc.shared" ".zprofile" ".p10k.zsh" ".vimrc" ".gitconfig" ".psqlrc" ".config/opencode/opencode.json" ".claude/settings.json" ".claude/CLAUDE.md" ".codex/config.toml" )
FILE_VALS=( "$HOME/.zshrc" "$HOME/.zshrc.shared" "$HOME/.zprofile" "$HOME/.p10k.zsh" "$HOME/.vimrc" "$HOME/.gitconfig" "$HOME/.psqlrc" "$HOME/.config/opencode/opencode.json" "$HOME/.claude/settings.json" "$HOME/.claude/CLAUDE.md" "$HOME/.codex/config.toml" )
